...
/// <summary>
/// Abstraction over <see cref="BuildsService"/> consumed by Razor components.
///
...
public interface IBuildsService
{
    ...
    /// <summary>
    /// Fetches (and caches) the build manifest. Returns null on failure.
    /// </summary>
    Task<BuildManifest?> FetchManifestAsync();

    /// <summary>
    /// Fetches, processes, and caches the rendered HTML for a build's main page.
    /// Returns null on failure.
    /// </summary>
    Task<string?> FetchBuildHtmlAsync(string slug);
